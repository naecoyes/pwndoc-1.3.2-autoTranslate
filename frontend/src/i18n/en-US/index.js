export default {
    ...
    enableLLMDescription: 'Enable AI-powered features for vulnerability completion and translation',
    llmProvider: 'LLM Provider',
    selectLLMProvider: 'Select your preferred LLM provider and model',
    provider: 'Provider',
    model: 'Model',
    modelHint: 'e.g., gpt-3.5-turbo, gpt-4',
    apiConfiguration: 'API Configuration',
    apiConfigurationDescription: 'Configure API credentials and parameters',
    apiKey: 'API Key',
    apiKeyHint: 'Your API key for the selected provider',
    apiEndpoint: 'API Endpoint',
    apiEndpointHint: 'Custom API endpoint (optional)',
    maxTokens: 'Max Tokens',
    maxTokensHint: 'Maximum tokens for AI responses (100-8000)',
    temperature: 'Temperature',
    temperatureHint: 'Creativity level (0.0-2.0)',
    organizationId: 'Organization ID',
    organizationIdHint: 'OpenAI organization ID (optional)',
    aiComplete: 'AI Complete',
    aiNotEnabled: 'AI service is not enabled',
    aiCompletionSuccess: 'AI completion successful',
    aiCompletionError: 'AI completion failed',
