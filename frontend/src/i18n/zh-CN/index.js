export default {
    ...
    enableLLM: '启用LLM功能',
    enableLLMDescription: '启用AI驱动的漏洞补全和翻译功能',
    llmProvider: 'LLM提供商',
    selectLLMProvider: '选择您偏好的LLM提供商和模型',
    openai: 'OpenAI',
    anthropic: 'Anthropic',
    google: 'Google',
    azure: 'Azure OpenAI',
    ollama: 'Ollama',
    apiKey: 'API密钥',
    apiKeyHint: '您所选提供商的API密钥',
    apiEndpoint: 'API端点',
    apiEndpointHint: '自定义API端点（可选）',
    maxTokens: '最大令牌数',
    maxTokensHint: '响应的最大令牌数',
    temperature: '温度',
    temperatureHint: '控制响应的随机性（0.0-1.0）',
    organizationId: '组织ID',
    organizationIdHint: '您的组织ID（可选）',
    nav: {
        audits: '项目审计',
